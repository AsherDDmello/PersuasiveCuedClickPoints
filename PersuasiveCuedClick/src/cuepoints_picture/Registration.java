...
public class Registration extends javax.swing.JFrame implements MouseListener{
...
//         MAX=5;
    ...
    public Registration(String Fullname,String LoginName,String Role,String Question,String Answer,int MAX)
    {
        FULLNAME=Fullname;
        LOGINNAME=LoginName;
        ROLE=Role;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cuepoints_picture.CuePoints_PictureApp.class).getContext().getResourceMap(Registration.class);
        ...
        jButton1.setBounds(160, 520, 120, 50);
        ...
        jButton2.setBounds(290, 520, 100, 50);
        ...
        jLabel2.setBounds(20, 110, 130, 15);
        ...
        jLabel3.setBounds(20, 150, 150, 15);
        ...
        jLabel10.setBounds(320, 110, 120, 120);

        jLabel6.setIcon(resourceMap.getIcon("jLabel6.icon")); // NOI18N
        jLabel6.setText(resourceMap.getString("jLabel6.text")); // NOI18N
        jLabel6.setName("jLabel6"); // NOI18N
        getContentPane().add(jLabel6);
        jLabel6.setBounds(320, 100, 128, 120);
        ...
        jButton5.setText(resourceMap.getString("Refresh.text")); // NOI18N
        ...
        jButton5.setBounds(400, 520, 71, 50);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            conn=ConnectionModel.getConnection();
            Statement stmt=conn.createStatement();
            ResultSet rs=stmt.executeQuery("select count(*) from cuepoints_registration where loginname like '"+jTextField1.getText()+"' ");
            rs.next();
            int cnt=rs.getInt(1);
            if(cnt>1)
            {
                  JOptionPane.showMessageDialog(this,"Already Member Exit Plz Select Another Username");
                  jTextField1.setText("");
                  jTextField2.setText("");
                  jTextField3.setText("");
                  jTextField4.setText("");
         ...
         boolean result=pcp.insertData(jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),jTextField4.getText(),jTextField5.getText(),MAX);
        if(result)
        {
           ...
           */ 
           ...
           jLabel9.setVisible(true);
            jLabel9.setText(""+"REGISTRATION SUCCESSFULL");
        ...
        { //System.out.println("aaaaaa"+choiceno);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String[] Axis = cuepoint.getText().split(",");
        if((ImageLabel.XAxis < Integer.parseInt(Axis[0]) &&  Integer.parseInt(Axis[0]) < ImageLabel.XAxis+(640/choiceno)) && (ImageLabel.YAxis < Integer.parseInt(Axis[1]) &&  Integer.parseInt(Axis[1]) < ImageLabel.YAxis+(480/choiceno)))
        {
        ...
        {
            JOptionPane.showMessageDialog(this,"Please select in the Rectangle");
        }
