...
public class LoginFrame extends javax.swing.JFrame implements MouseListener {
    double rohan,victor,chiku,vic,asher,ash,test1,ru;
    ArrayList pk;
    ...
    private void initComponents() {
        ...
        jRadioButton1.setBounds(40, 320, 370, 20);
        ...
        jLabel1.setBounds(30, 120, 80, 40);

        jLabel2.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        jLabel2.setText(resourceMap.getString("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(20, 260, 440, 0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Forgot_Password one=new Forgot_Password();
        this.setVisible(false);
        one.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(option==-1)
        {
            JOptionPane.showMessageDialog(this,"Please Select the Radio Button ");
            return;
        }
        if(option==1)
        {
         ...
         int cnt;
          ...
          for(cnt=1;cnt<=rsmd.getColumnCount();cnt++)
          {
             b=rs.getBlob(cnt);
              ...
              is.read(data);
              fos=new FileOutputStream("D:\\dump_global\\" + file + "" + cnt + ".jpg");
              fos.write(data);
              fos.close();
         }
         rs.close();
 ...
 ImageLabelNoGrid imglbl=new ImageLabelNoGrid(0,0,jPanel3.getBounds().height,jPanel3.getBounds().width,choiceno,filename);
    ...
    private void showNextImage1(int cnt)
    {
             File f=new File("D:\\rohan");
                    File []all=f.listFiles();
                    int idx=0;
                     choiceno=10;
                    String filename=all[cnt].getAbsolutePath();
            ImageLabelNoGrid imglbl=new ImageLabelNoGrid(0,0,jPanel3.getBounds().height,jPanel3.getBounds().width,choiceno,filename);
              jPanel3.removeAll();
        imglbl.revalidate();
        imglbl.repaint();
...
// pk=au.getMyPoints();
 ...
 String block=getCodeforClick(p);
  System.out.println(block);
        ...
        String []parts1;
       System.out.println(parts[global]);



       

//    lok    divide the strig i two parts*/
rohan=Double.parseDouble(block.substring(0,3));

 victor=Double.parseDouble(block.substring(3,6));

  System.out.println("x OF OG POInT"+rohan);
         System.out.println("Y OF OG POInt"+victor);

        //  parts      divide the strig i two parts*/
chiku=Double.parseDouble(parts[global].substring(0,3));

 vic=Double.parseDouble(parts[global].substring(3,6));

  System.out.println("x of login "+chiku);
         System.out.println("y of login"+vic);

//uclidian done

asher=(rohan-chiku)*(rohan-chiku);
ash=(victor-vic)*(victor-vic);
ru=asher+ash;
test1=Math.sqrt(ru);
System.out.println("+++ EUClidian Distace between the poits++++");
...
{JOptionPane.showMessageDialog(this,"Authentication Confirmed!");
 ...
 /*else{JOptionPane.showMessageDialog(this,"Authentication Confirmed!");
                useraccount m=new useraccount();
                m.setVisible(true);
                this.setVisible(false);
                return;}*/
//if(parts[global].equals(block)) // verfiy code just today
//attempts=attempts+1;
        if(test1<=1) // verfiy code
        {
    ...
    attempts++;
          showNextImage1(attempts);
//          attempts++; // JOptionPane.showMessageDialog(this,"Invalid CuePoint Selected ");
        }}
//attempts=attempts+1;
        }
        else
        ...
        if(test1<=1)
////       todYYY if(parts[global].equals(block))
        {
        //    String []points=au.getMyPoints().get(0).toString().split("#");
         // if(cuepoint.equals(points[global]))
         // {
